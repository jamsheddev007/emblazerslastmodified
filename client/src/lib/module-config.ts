...
export const studentPortalConfig = {
  ...
  dashboardPath: "/curriculum/student-dashboard",
  description: "Students can view results, attendance, fees, homework and more",
};
...
export const moduleConfigs: Record<string, ModuleConfig> = {
  ...
  parent: {
    ...
    description: "Children ki fee, attendance aur results dekhein",
  },
  "staff-portal": {
    id: "staff-portal",
    name: "Employee Portal",
    shortName: "Employee Portal",
    icon: UserCircle,
    color: "text-teal-600 dark:text-teal-400",
    bgColor: "bg-teal-600",
    ...
    description: "View profile, attendance, salary slips & documents",
  },
  "student-portal": studentPortalConfig,
};
